				...
				[
					...
					[
						...
						[
							...
							.ToolTipText(LOCTEXT("FreezeRotationTip", "Freeze rotation when baking"))
							.Content()
							[
								SNew(STextBlock)
						...
						[
							SNew(SCheckBox)
							.OnCheckStateChanged(this, &SPivotToolWidget::OnFreezeScaleCheckStateChanged)
							.IsChecked(this, &SPivotToolWidget::IsFreezeScale)
							.ToolTipText(LOCTEXT("FreezeScaleTip", "Freeze scale when baking"))
							.Content()
							[
								SNew(STextBlock)
						...
						[
							SNew(SCheckBox)
							.OnCheckStateChanged(this, &SPivotToolWidget::OnKeepActorsInPlaceChanged)
							.IsChecked(this, &SPivotToolWidget::IsKeepActorsInPlace)
							.ToolTipText(LOCTEXT("KeepActorsInPlaceTip", "Try to keep actors in the level referencing same StaticMesh in place"))
							.Content()
							[
								SNew(STextBlock)
...
ECheckBoxState SPivotToolWidget::IsFreezeScale() const
{
	return bFreezeScale ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
}

void SPivotToolWidget::OnFreezeScaleCheckStateChanged(ECheckBoxState NewCHeckedState)
{
	bFreezeScale = NewCHeckedState == ECheckBoxState::Checked;
	SaveUISetting();
}
...
ECheckBoxState SPivotToolWidget::IsKeepActorsInPlace() const
{
	return bKeepActorsInPlace ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
}

void SPivotToolWidget::OnKeepActorsInPlaceChanged(ECheckBoxState NewCHeckedState)
{
	bKeepActorsInPlace = NewCHeckedState == ECheckBoxState::Checked;
	SaveUISetting();
}
...
void SPivotToolWidget::UpdateOptions(FPivotToolOptions& Options)
{
	...
	Options.bFreezeScale = IsFreezeScale() == ECheckBoxState::Checked;
	Options.bKeepActorsInPlace = IsKeepActorsInPlace() == ECheckBoxState::Checked;
}
