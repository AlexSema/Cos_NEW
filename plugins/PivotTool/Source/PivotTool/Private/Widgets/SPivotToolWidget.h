...
private:
	...
	ECheckBoxState IsFreezeScale() const;
	void OnFreezeScaleCheckStateChanged(ECheckBoxState NewCHeckedState);
	FText GetFreezeScaleCheckboxText() const;

	ECheckBoxState IsKeepActorsInPlace() const;
	void OnKeepActorsInPlaceChanged(ECheckBoxState NewCHeckedState);
